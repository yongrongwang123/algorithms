...
var main = function() {
    ...
    console.log('arr: ' + arr);
    console.log('k: ' + k);
    let queue = new MyCircularQueue(k);
    console.log('enQueue: ' + queue.enQueue(arr[0]));
    console.log('enQueue: ' + queue.enQueue(arr[1]));
    console.log('enQueue: ' + queue.enQueue(arr[2]));
    console.log('enQueue: ' + queue.enQueue(arr[3]));
    console.log('rear: ' + queue.Rear());
    console.log('isFull: ' + queue.isFull());
    console.log('deQueue: ' + queue.deQueue());
    console.log('enQueue: ' + queue.enQueue(arr[4]));
    console.log('rear: ' + queue.Rear());
}
