 ...
 *    row is 0110. Given two integer n and k,
...
public class KthGrammar {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("kth: " + kth.kthGrammar(n, k));
    }
     ...
     *  / \ / \
     * 0  1 1  0
     * 所有的0和1组合起来可以看成一个二叉树，如果当前节点是0，则它的两个左右子节点分别
    ...
    public int kthGrammar(int n, int k) {
        ...
        int grammar = kthGrammar(n - 1, (k + 1) / 2);
