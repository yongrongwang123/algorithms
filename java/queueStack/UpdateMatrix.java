...
public class UpdateMatrix {
    ...
    public static void main(String[] args) {
        ...
        u.print2dArray(mat);
        u.print2dArray(um.updateMatrix(mat));
    }
    
    /**
     * 使用队列来保证处理的顺序是从0出发由近及远进行处理。先将所有为0的元素的索引压入队列，
     * 并且把所有的非0元素设置为-1来打上标记，之后每次弹出一个元素的索引就按照上下左右四
     * 个方向分别进行处理，如果该方向的索引合法且元素未被访问过，则将当前元素值设置为弹出
     * 来的索引所在的元素值加一，然后将当前索引压入队列
     */
