 ...
 * k. For example, there won't be input like 3a or 2[4]. The test cases are generated
 * so that the length of the output will never exceed 10^5.
 * 
 * Example 1:
 * Input: s = "3[a]2[bc]"
 * Output: "aaabcbc"
...
public class DecodeString {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("decoded: " + d.decodeString(s));;
    }
     ...
     * 2. 如果是']'：从stack1中弹出一个元素作为循环次数num，将builder作为循环子串，
     *    从stack2中弹出一个元素作为temp，然后在temp后面拼接num次循环子串builder
