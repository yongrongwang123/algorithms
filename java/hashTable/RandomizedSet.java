...
public class RandomizedSet {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("insert " + arr[0] + ": " + set.insert(arr[0]));
        System.out.println("remove " + arr[1] + ": " + set.remove(arr[1]));
        System.out.println("insert " + arr[1] + ": " + set.insert(arr[1]));
        System.out.println("random: " + set.getRandom());
        System.out.println("remove " + arr[0] + ": " + set.remove(arr[0]));
        System.out.println("insert " + arr[1] + ": " + set.insert(arr[1]));
        System.out.println("random: " + set.getRandom());
    }
