...
public class Connect {
    ...
    private TreeNode createTree() {
         ...
         *        1  2 3  4
         */
        int[] nums = {7,5,6,1,2,3,4};
        TreeNode node6 = new TreeNode(nums[6], null, null, null);
        TreeNode node5 = new TreeNode(nums[5], null, null, null);
        TreeNode node4 = new TreeNode(nums[4], null, null, null);
        TreeNode node3 = new TreeNode(nums[3], null, null, null);
    ...
    /**
     * 充分利用next指针，对于每一个有孩子的节点，将它的左孩子指向右孩子，右孩子指向下一
