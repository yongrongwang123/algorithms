...
public class GetIntersectionNode {
    ...
    public static void main(String[] args) {
        ...
        int skipA = 2;
        int skipB = 3;
        System.out.println("intersectVal: " + intersectVal);
        System.out.println("skipA: " + skipA);
        System.out.println("skipB: " + skipB);
        ...
        lists[0].visit();
        lists[1].visit();
        ListNode intersection = g.getIntersectionNode(lists[0].head, lists[1].head);
    ...
    public MyLinkedList[] createIntersection(int[] listA, int[] listB, int intersectVal,
        ...
        if (intersectVal != 0) {
            ...
            for (int i = skipA; i < listA.length; i++) {
                list3.addAtTail(listA[i]);
            }
            list1.addAtTailNode(list3.head);
            list2.addAtTailNode(list3.head);
        }
        return new MyLinkedList[]{list1, list2};
    }
